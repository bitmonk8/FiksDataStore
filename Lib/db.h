...
struct FDS_db
{
    ...
    uint16_t md_flags;         // fds_dbi_open
...
struct FDS_dbx
{
    FDS_val md_name;       // name of the database
    FDS_cmp_func md_cmp;   // function for comparing keys
    FDS_cmp_func md_dcmp;  // function for comparing data items
};
...
auto drop0(FDS_cursor* mc, int subs) -> int;
